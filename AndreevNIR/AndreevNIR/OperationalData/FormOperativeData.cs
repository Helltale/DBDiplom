...
namespace AndreevNIR.OperationalData
{
    public partial class FormOperativeData : Form
    {
        ...
        private string queryHistoryNames = "select full_name as \"ФИО пациента\" from patient";
